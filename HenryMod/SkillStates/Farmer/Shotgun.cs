...
namespace FirstLightMod.SkillStates
{
    ...
    {
        public static float damageCoefficient = Modules.Config.shotgunDamageCoefficient.Value;
            ...
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    ...
                    new BulletAttack
                    {
                        ...
                        weapon = null,
                        tracerEffectPrefab = Shoot.tracerEffectPrefab, // May want to take a look at this
                        spreadPitchScale = 0f,
                        spreadYawScale = 2.5f,
